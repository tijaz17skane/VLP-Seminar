...
from methods.utils.segmentation_loss import MixedLoss
...
class FinetuneSegmenter(LightningModule):
    def __init__(self, config,
        ...
        self.learning_rate = self.config["seg"].get("learning_rate", 5e-4)
        self.weight_decay = self.config["seg"].get("weight_decay", 1e-6)
